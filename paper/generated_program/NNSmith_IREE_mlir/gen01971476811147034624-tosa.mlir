module {
  func.func @main(%arg0: tensor<1x1x1x1xf32> {iree.identifier = "inputs_0"}) -> (tensor<1x1x1x1xi1> {iree.identifier = "Identity"}, tensor<1x1x1x1xi64> {iree.identifier = "Identity_1"}) {
    ...
    %18 = "tosa.cast"(%17) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xi64>
    %19 = "tosa.cast"(%arg0) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xi1>
    return %19, %18 : tensor<1x1x1x1xi1>, tensor<1x1x1x1xi64>
  }
}
