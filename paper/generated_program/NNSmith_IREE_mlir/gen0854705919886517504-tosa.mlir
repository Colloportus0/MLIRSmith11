module {
  func.func @main(%arg0: tensor<1x1x1x1xf32> {iree.identifier = "inputs_0"}) -> (tensor<1x1x1x1xf32> {iree.identifier = "Identity"}, tensor<1x1x1x1xf32> {iree.identifier = "Identity_1"}) {
    ...
    %19 = "tosa.add"(%18, %0) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %20 = "tosa.mul"(%19, %1) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %21 = "tosa.floor"(%20) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %22 = "tosa.sub"(%20, %21) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %23 = "tosa.mul"(%22, %2) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %24 = "tosa.sub"(%23, %3) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %25 = "tosa.mul"(%24, %4) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %26 = "tosa.cast"(%25) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xi16>
    %27 = "tosa.table"(%26, %6) : (tensor<1x1x1x1xi16>, tensor<513xi16>) -> tensor<1x1x1x1xi32>
    %28 = "tosa.cast"(%27) : (tensor<1x1x1x1xi32>) -> tensor<1x1x1x1xf32>
    %29 = "tosa.mul"(%28, %5) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %30 = "tosa.negate"(%29) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %31 = "tosa.maximum"(%18, %7) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    return %31, %30 : tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>
  }
}
