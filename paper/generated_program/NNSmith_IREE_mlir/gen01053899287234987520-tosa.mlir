module {
  func.func @main(%arg0: tensor<2x1x1x1xf32> {iree.identifier = "inputs_0"}, %arg1: tensor<2x1x1x1xf32> {iree.identifier = "inputs_1"}) -> (tensor<8xf32> {iree.identifier = "Identity"}, tensor<2x1x1x4xf32> {iree.identifier = "Identity_1"}) {
    ...
    %2 = "tosa.const"() {value = dense<1.57079637> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    %3 = "tosa.const"() {value = dense<0.159154937> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    %4 = "tosa.const"() {value = dense<2.000000e+00> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    %5 = "tosa.const"() {value = dense<1.000000e+00> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    %6 = "tosa.const"() {value = dense<3.276700e+04> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    %7 = "tosa.const"() {value = dense<2.38418579E-7> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    %8 = "tosa.const"() {value = dense<5.69302893> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    %9 = "tosa.const"() {value = dense<2.50004196> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    ...
    %11 = "tosa.const"() {value = dense<[[[[5.26619625]]], [[[5.16894341]]]]> : tensor<2x1x1x1xf32>} : () -> tensor<2x1x1x1xf32>
    %12 = "tosa.const"() {value = dense<[[[[5.00272131]]], [[[3.57571197]]]]> : tensor<2x1x1x1xf32>} : () -> tensor<2x1x1x1xf32>
    %13 = "tosa.concat"(%arg1, %arg0, %11, %12) {axis = 3 : i64} : (tensor<2x1x1x1xf32>, tensor<2x1x1x1xf32>, tensor<2x1x1x1xf32>, tensor<2x1x1x1xf32>) -> tensor<2x1x1x4xf32>
    %14 = "tosa.minimum"(%13, %0) : (tensor<2x1x1x4xf32>, tensor<1x1x1x1xf32>) -> tensor<2x1x1x4xf32>
    %15 = "tosa.maximum"(%14, %1) : (tensor<2x1x1x4xf32>, tensor<1x1x1x1xf32>) -> tensor<2x1x1x4xf32>
    %16 = "tosa.add"(%15, %2) : (tensor<2x1x1x4xf32>, tensor<1x1x1x1xf32>) -> tensor<2x1x1x4xf32>
    %17 = "tosa.mul"(%16, %3) {shift = 0 : i32} : (tensor<2x1x1x4xf32>, tensor<1x1x1x1xf32>) -> tensor<2x1x1x4xf32>
    %18 = "tosa.floor"(%17) : (tensor<2x1x1x4xf32>) -> tensor<2x1x1x4xf32>
    %19 = "tosa.sub"(%17, %18) : (tensor<2x1x1x4xf32>, tensor<2x1x1x4xf32>) -> tensor<2x1x1x4xf32>
    %20 = "tosa.mul"(%19, %4) {shift = 0 : i32} : (tensor<2x1x1x4xf32>, tensor<1x1x1x1xf32>) -> tensor<2x1x1x4xf32>
    %21 = "tosa.sub"(%20, %5) : (tensor<2x1x1x4xf32>, tensor<1x1x1x1xf32>) -> tensor<2x1x1x4xf32>
    %22 = "tosa.mul"(%21, %6) {shift = 0 : i32} : (tensor<2x1x1x4xf32>, tensor<1x1x1x1xf32>) -> tensor<2x1x1x4xf32>
    %23 = "tosa.cast"(%22) : (tensor<2x1x1x4xf32>) -> tensor<2x1x1x4xi16>
    %24 = "tosa.table"(%23, %10) : (tensor<2x1x1x4xi16>, tensor<513xi16>) -> tensor<2x1x1x4xi32>
    %25 = "tosa.cast"(%24) : (tensor<2x1x1x4xi32>) -> tensor<2x1x1x4xf32>
    %26 = "tosa.mul"(%25, %7) {shift = 0 : i32} : (tensor<2x1x1x4xf32>, tensor<1x1x1x1xf32>) -> tensor<2x1x1x4xf32>
    %27 = "tosa.mul"(%15, %8) {shift = 0 : i32} : (tensor<2x1x1x4xf32>, tensor<1x1x1x1xf32>) -> tensor<2x1x1x4xf32>
    %28 = "tosa.add"(%27, %9) : (tensor<2x1x1x4xf32>, tensor<1x1x1x1xf32>) -> tensor<2x1x1x4xf32>
    %29 = "tosa.reshape"(%26) {new_shape = [8]} : (tensor<2x1x1x4xf32>) -> tensor<8xf32>
    return %29, %28 : tensor<8xf32>, tensor<2x1x1x4xf32>
  }
}
