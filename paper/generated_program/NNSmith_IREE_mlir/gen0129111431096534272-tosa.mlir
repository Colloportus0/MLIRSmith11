module {
  func.func @main(%arg0: tensor<1x1x1x1xf32> {iree.identifier = "inputs_0"}) -> (tensor<1x1x1x1xf32> {iree.identifier = "Identity"}, tensor<1x1x1xf32> {iree.identifier = "Identity_1"}) {
    ...
    %7 = "tosa.const"() {value = dense<4.4559927> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    %8 = "tosa.const"() {value = dense<6.03324413> : tensor<1xf32>} : () -> tensor<1xf32>
    ...
    %20 = "tosa.ceil"(%19) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %21 = "tosa.conv2d"(%20, %7, %8) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>, tensor<1xf32>) -> tensor<1x1x1x1xf32>
    %22 = "tosa.reshape"(%21) {new_shape = [1, 1, 1]} : (tensor<1x1x1x1xf32>) -> tensor<1x1x1xf32>
    return %20, %22 : tensor<1x1x1x1xf32>, tensor<1x1x1xf32>
  }
}
