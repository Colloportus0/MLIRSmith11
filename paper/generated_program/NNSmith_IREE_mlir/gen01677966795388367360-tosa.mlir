module {
  func.func @main(%arg0: tensor<1x1x1x1xf32> {iree.identifier = "inputs_0"}) -> (tensor<1x1x1x1xf32> {iree.identifier = "Identity"}, tensor<1x1x1x1xi32> {iree.identifier = "Identity_1"}, tensor<1x1x1x1xf32> {iree.identifier = "Identity_2"}) {
    ...
    %7 = "tosa.const"() {value = dense<6.14387512> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    %8 = "tosa.const"() {value = dense<4.06285524> : tensor<1xf32>} : () -> tensor<1xf32>
    %9 = "tosa.cast"(%arg0) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xi32>
    %10 = "tosa.conv2d"(%arg0, %7, %8) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>, tensor<1xf32>) -> tensor<1x1x1x1xf32>
    ...
    %22 = "tosa.resize"(%arg0) {mode = "NEAREST_NEIGHBOR", offset = [0, 0], offset_fp = [0.000000e+00 : f32, 0.000000e+00 : f32], output_size = [1, 1], shift = 0 : i32, stride = [0, 0], stride_fp = [1.000000e+00 : f32, 1.000000e+00 : f32]} : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    return %22, %9, %21 : tensor<1x1x1x1xf32>, tensor<1x1x1x1xi32>, tensor<1x1x1x1xf32>
  }
}
