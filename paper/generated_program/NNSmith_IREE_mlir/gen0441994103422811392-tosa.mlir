module {
  func.func @main(%arg0: tensor<1x1x1x1x1xf32> {iree.identifier = "inputs_0"}) -> (tensor<1x1x1x1x1xf32> {iree.identifier = "Identity"}, tensor<1x1x1x1xf32> {iree.identifier = "Identity_1"}) {
    ...
    %7 = "tosa.reshape"(%arg0) {new_shape = [1, 1, 1, 1]} : (tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %8 = "tf.Atan"(%7) {T = f32} : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %9 = "tosa.add"(%arg0, %0) : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %10 = "tosa.mul"(%9, %1) {shift = 0 : i32} : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %11 = "tosa.floor"(%10) : (tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %12 = "tosa.sub"(%10, %11) : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %13 = "tosa.mul"(%12, %2) {shift = 0 : i32} : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %14 = "tosa.sub"(%13, %3) : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %15 = "tosa.mul"(%14, %4) {shift = 0 : i32} : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %16 = "tosa.cast"(%15) : (tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xi16>
    %17 = "tosa.table"(%16, %6) : (tensor<1x1x1x1x1xi16>, tensor<513xi16>) -> tensor<1x1x1x1x1xi32>
    %18 = "tosa.cast"(%17) : (tensor<1x1x1x1x1xi32>) -> tensor<1x1x1x1x1xf32>
    %19 = "tosa.mul"(%18, %5) {shift = 0 : i32} : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %20 = "tosa.negate"(%19) : (tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    return %20, %8 : tensor<1x1x1x1x1xf32>, tensor<1x1x1x1xf32>
  }
}
