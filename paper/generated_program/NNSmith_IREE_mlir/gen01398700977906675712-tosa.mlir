module {
  func.func @main(%arg0: tensor<1x1x1x1x1xf32> {iree.identifier = "inputs_0"}) -> (tensor<1x1x1x1x1xi32> {iree.identifier = "Identity"}, tensor<1x1x1x1xf32> {iree.identifier = "Identity_1"}, tensor<1x1x1x1xf32> {iree.identifier = "Identity_2"}) {
    %0 = "tosa.const"() {value = dense<0.159154937> : tensor<1x1x1x1x1xf32>} : () -> tensor<1x1x1x1x1xf32>
    %1 = "tosa.const"() {value = dense<2.000000e+00> : tensor<1x1x1x1x1xf32>} : () -> tensor<1x1x1x1x1xf32>
    %2 = "tosa.const"() {value = dense<1.000000e+00> : tensor<1x1x1x1x1xf32>} : () -> tensor<1x1x1x1x1xf32>
    %3 = "tosa.const"() {value = dense<3.276700e+04> : tensor<1x1x1x1x1xf32>} : () -> tensor<1x1x1x1x1xf32>
    %4 = "tosa.const"() {value = dense<2.38418579E-7> : tensor<1x1x1x1x1xf32>} : () -> tensor<1x1x1x1x1xf32>
    %5 = "tosa.const"() {value = dense<[1, 2, 3, 4, 0]> : tensor<5xi32>} : () -> tensor<5xi32>
    ...
    %7 = "tosa.mul"(%arg0, %0) {shift = 0 : i32} : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %8 = "tosa.floor"(%7) : (tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %9 = "tosa.sub"(%7, %8) : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %10 = "tosa.mul"(%9, %1) {shift = 0 : i32} : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %11 = "tosa.sub"(%10, %2) : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %12 = "tosa.mul"(%11, %3) {shift = 0 : i32} : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %13 = "tosa.cast"(%12) : (tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xi16>
    %14 = "tosa.table"(%13, %6) : (tensor<1x1x1x1x1xi16>, tensor<513xi16>) -> tensor<1x1x1x1x1xi32>
    %15 = "tosa.cast"(%14) : (tensor<1x1x1x1x1xi32>) -> tensor<1x1x1x1x1xf32>
    %16 = "tosa.mul"(%15, %4) {shift = 0 : i32} : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %17 = "tosa.cast"(%16) : (tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xi32>
    %18 = "tosa.transpose"(%16, %5) : (tensor<1x1x1x1x1xf32>, tensor<5xi32>) -> tensor<1x1x1x1x1xi32>
    %19 = "tosa.reshape"(%18) {new_shape = [1, 1, 1, 1]} : (tensor<1x1x1x1x1xi32>) -> tensor<1x1x1x1xf32>
    %20 = "tosa.reshape"(%16) {new_shape = [1, 1, 1, 1]} : (tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    return %17, %19, %20 : tensor<1x1x1x1x1xi32>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>
  }
}
