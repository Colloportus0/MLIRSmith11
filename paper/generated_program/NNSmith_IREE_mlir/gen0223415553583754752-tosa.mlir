module {
  func.func @main(%arg0: tensor<1x1x1x1x1xf32> {iree.identifier = "inputs_0"}) -> (tensor<1x1x1x1x1xf32> {iree.identifier = "Identity"}, tensor<1x1x1xf32> {iree.identifier = "Identity_1"}, tensor<1x1x1x1xf32> {iree.identifier = "Identity_2"}) {
    ...
    %7 = "tosa.exp"(%arg0) : (tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %8 = "tosa.reciprocal"(%7) : (tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %9 = "tosa.mul"(%7, %8) {shift = 0 : i32} : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %10 = "tosa.reshape"(%9) {new_shape = [1, 1, 1, 1]} : (tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %11 = "tosa.reshape"(%9) {new_shape = [1, 1, 1]} : (tensor<1x1x1x1x1xf32>) -> tensor<1x1x1xf32>
    %12 = "tosa.add"(%10, %1) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    ...
    %17 = "tosa.sub"(%16, %0) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %18 = "tosa.mul"(%17, %4) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %19 = "tosa.cast"(%18) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xi16>
    %20 = "tosa.table"(%19, %6) : (tensor<1x1x1x1xi16>, tensor<513xi16>) -> tensor<1x1x1x1xi32>
    %21 = "tosa.cast"(%20) : (tensor<1x1x1x1xi32>) -> tensor<1x1x1x1xf32>
    %22 = "tosa.mul"(%21, %5) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    return %9, %11, %22 : tensor<1x1x1x1x1xf32>, tensor<1x1x1xf32>, tensor<1x1x1x1xf32>
  }
}
