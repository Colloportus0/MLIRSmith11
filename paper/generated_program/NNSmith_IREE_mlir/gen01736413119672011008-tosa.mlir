module {
  func.func @main(%arg0: tensor<1x1x1x1xf32> {iree.identifier = "inputs_0"}) -> (tensor<1x1x1x1xf32> {iree.identifier = "Identity"}, tensor<1x1xf32> {iree.identifier = "Identity_1"}) {
    ...
    %6 = "tosa.floor"(%arg0) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    ...
    %17 = "tosa.avg_pool2d"(%6) {kernel = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %18 = "tosa.reshape"(%16) {new_shape = [1, 1]} : (tensor<1x1x1x1xf32>) -> tensor<1x1xf32>
    return %17, %18 : tensor<1x1x1x1xf32>, tensor<1x1xf32>
  }
}
