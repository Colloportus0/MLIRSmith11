module {
  func.func @main(%arg0: tensor<1x1x1x1x1xf32> {iree.identifier = "inputs_0"}) -> (tensor<1x1x1x1xf32> {iree.identifier = "Identity"}) {
    ...
    %2 = "tosa.const"() {value = dense<0.159154937> : tensor<1x1x1x1x1xf32>} : () -> tensor<1x1x1x1x1xf32>
    %3 = "tosa.const"() {value = dense<2.000000e+00> : tensor<1x1x1x1x1xf32>} : () -> tensor<1x1x1x1x1xf32>
    %4 = "tosa.const"() {value = dense<1.000000e+00> : tensor<1x1x1x1x1xf32>} : () -> tensor<1x1x1x1x1xf32>
    %5 = "tosa.const"() {value = dense<3.276700e+04> : tensor<1x1x1x1x1xf32>} : () -> tensor<1x1x1x1x1xf32>
    %6 = "tosa.const"() {value = dense<2.38418579E-7> : tensor<1x1x1x1x1xf32>} : () -> tensor<1x1x1x1x1xf32>
    %7 = "tosa.const"() {value = dense<[1, 2, 3, 4, 0]> : tensor<5xi32>} : () -> tensor<5xi32>
    ...
    %9 = "tosa.const"() {value = dense<6.69970035> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    %10 = "tosa.const"() {value = dense<6.16951561> : tensor<1xf32>} : () -> tensor<1xf32>
    %11 = "tosa.mul"(%arg0, %0) {shift = 0 : i32} : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %12 = "tosa.greater_equal"(%arg0, %1) : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xi1>
    %13 = "tosa.select"(%12, %arg0, %11) : (tensor<1x1x1x1x1xi1>, tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %14 = "tosa.mul"(%13, %2) {shift = 0 : i32} : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %15 = "tosa.floor"(%14) : (tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %16 = "tosa.sub"(%14, %15) : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %17 = "tosa.mul"(%16, %3) {shift = 0 : i32} : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %18 = "tosa.sub"(%17, %4) : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %19 = "tosa.mul"(%18, %5) {shift = 0 : i32} : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %20 = "tosa.cast"(%19) : (tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xi16>
    %21 = "tosa.table"(%20, %8) : (tensor<1x1x1x1x1xi16>, tensor<513xi16>) -> tensor<1x1x1x1x1xi32>
    %22 = "tosa.cast"(%21) : (tensor<1x1x1x1x1xi32>) -> tensor<1x1x1x1x1xf32>
    %23 = "tosa.mul"(%22, %6) {shift = 0 : i32} : (tensor<1x1x1x1x1xf32>, tensor<1x1x1x1x1xf32>) -> tensor<1x1x1x1x1xf32>
    %24 = "tosa.transpose"(%23, %7) : (tensor<1x1x1x1x1xf32>, tensor<5xi32>) -> tensor<1x1x1x1x1xi32>
    %25 = "tosa.reshape"(%24) {new_shape = [1, 1, 1, 1]} : (tensor<1x1x1x1x1xi32>) -> tensor<1x1x1x1xf32>
    %26 = "tosa.clamp"(%25) {max_fp = 3.40282347E+38 : f32, max_int = 2147483647 : i64, min_fp = 0.000000e+00 : f32, min_int = 0 : i64} : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %27 = "tosa.conv2d"(%26, %9, %10) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>, tensor<1xf32>) -> tensor<1x1x1x1xf32>
    return %27 : tensor<1x1x1x1xf32>
  }
}
