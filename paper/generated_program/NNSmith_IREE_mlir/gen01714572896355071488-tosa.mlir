module {
  func.func @main(%arg0: tensor<1x1x1x1xf32> {iree.identifier = "inputs_0"}, %arg1: tensor<1xf32> {iree.identifier = "inputs_1"}) -> (tensor<1x1x1x1xf32> {iree.identifier = "Identity"}) {
    ...
    %7 = "tosa.sigmoid"(%arg0) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %8 = "tosa.reshape"(%arg1) {new_shape = [1, 1, 1, 1]} : (tensor<1xf32>) -> tensor<1x1x1x1xf32>
