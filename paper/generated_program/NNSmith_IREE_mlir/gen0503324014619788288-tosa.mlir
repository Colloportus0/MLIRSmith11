module {
  func.func @main(%arg0: tensor<1x1x1x1xf32> {iree.identifier = "inputs_0"}) -> (tensor<1x1xf32> {iree.identifier = "Identity"}) {
    ...
    %5 = "tosa.const"() {value = dense<1.500000e+00> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    %6 = "tosa.const"() {value = dense<-1.500000e+00> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    ...
    %8 = "tosa.mul"(%arg0, %0) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %9 = "tosa.floor"(%8) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %10 = "tosa.sub"(%8, %9) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %11 = "tosa.mul"(%10, %1) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %12 = "tosa.sub"(%11, %2) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %13 = "tosa.mul"(%12, %3) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %14 = "tosa.cast"(%13) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xi16>
    %15 = "tosa.table"(%14, %7) : (tensor<1x1x1x1xi16>, tensor<513xi16>) -> tensor<1x1x1x1xi32>
    %16 = "tosa.cast"(%15) : (tensor<1x1x1x1xi32>) -> tensor<1x1x1x1xf32>
    %17 = "tosa.mul"(%16, %4) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %18 = "tosa.minimum"(%17, %5) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %19 = "tosa.maximum"(%18, %6) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %20 = "tosa.reshape"(%19) {new_shape = [1, 1]} : (tensor<1x1x1x1xf32>) -> tensor<1x1xf32>
    return %20 : tensor<1x1xf32>
  }
}
