module {
  func.func @main(%arg0: tensor<1x1x1x1xf32> {iree.identifier = "inputs_0"}) -> (tensor<1x1x1x1xf32> {iree.identifier = "Identity"}, tensor<1x1x1x1xf32> {iree.identifier = "Identity_1"}) {
    ...
    %7 = "tosa.negate"(%arg0) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %8 = "tosa.abs"(%7) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %9 = "tosa.negate"(%8) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %10 = "tosa.add"(%8, %0) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %11 = "tosa.mul"(%10, %1) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %12 = "tosa.floor"(%11) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %13 = "tosa.sub"(%11, %12) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %14 = "tosa.mul"(%13, %2) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %15 = "tosa.sub"(%14, %3) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %16 = "tosa.mul"(%15, %4) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %17 = "tosa.cast"(%16) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xi16>
    %18 = "tosa.table"(%17, %6) : (tensor<1x1x1x1xi16>, tensor<513xi16>) -> tensor<1x1x1x1xi32>
    %19 = "tosa.cast"(%18) : (tensor<1x1x1x1xi32>) -> tensor<1x1x1x1xf32>
    %20 = "tosa.mul"(%19, %5) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    return %9, %20 : tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>
  }
}
