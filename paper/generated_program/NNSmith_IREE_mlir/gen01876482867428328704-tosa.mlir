module {
  func.func @main(%arg0: tensor<1x1x1x1xf32> {iree.identifier = "inputs_0"}) -> (tensor<1x1x1x1xi64> {iree.identifier = "Identity"}, tensor<1x1x1x1xf32> {iree.identifier = "Identity_1"}) {
    ...
    %7 = "tosa.const"() {value = dense<0.00999999977> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    %8 = "tosa.const"() {value = dense<0.000000e+00> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    ...
    %10 = "tosa.add"(%arg0, %0) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %11 = "tosa.floor"(%10) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %12 = "tosa.add"(%11, %1) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %13 = "tosa.mul"(%12, %2) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %14 = "tosa.floor"(%13) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %15 = "tosa.sub"(%13, %14) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %16 = "tosa.mul"(%15, %3) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %17 = "tosa.sub"(%16, %4) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %18 = "tosa.mul"(%17, %5) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %19 = "tosa.cast"(%18) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xi16>
    %20 = "tosa.table"(%19, %9) : (tensor<1x1x1x1xi16>, tensor<513xi16>) -> tensor<1x1x1x1xi32>
    %21 = "tosa.cast"(%20) : (tensor<1x1x1x1xi32>) -> tensor<1x1x1x1xf32>
    %22 = "tosa.mul"(%21, %6) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %23 = "tosa.mul"(%22, %7) {shift = 0 : i32} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %24 = "tosa.greater_equal"(%22, %8) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xi1>
    %25 = "tosa.select"(%24, %22, %23) : (tensor<1x1x1x1xi1>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    %26 = "tosa.cast"(%25) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xi64>
    return %26, %25 : tensor<1x1x1x1xi64>, tensor<1x1x1x1xf32>
  }
}
