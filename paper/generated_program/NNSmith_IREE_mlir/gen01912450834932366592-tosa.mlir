module {
  func.func @main(%arg0: tensor<1x1x1x1xf32> {iree.identifier = "inputs_0"}) -> (tensor<1x1x1x1xf32> {iree.identifier = "Identity"}, tensor<1x1x1x1xi32> {iree.identifier = "Identity_1"}, tensor<1x1x1x1xf32> {iree.identifier = "Identity_2"}) {
    ...
    %7 = "tosa.const"() {value = dense<3.07108641> : tensor<1x1x1x1xf32>} : () -> tensor<1x1x1x1xf32>
    %8 = "tosa.const"() {value = dense<4.76738214> : tensor<1xf32>} : () -> tensor<1xf32>
    %9 = "tosa.add"(%arg0, %0) : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
    ...
    %20 = "tosa.cast"(%19) : (tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xi32>
    %21 = "tosa.conv2d"(%19, %7, %8) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>, tensor<1xf32>) -> tensor<1x1x1x1xf32>
    return %19, %20, %21 : tensor<1x1x1x1xf32>, tensor<1x1x1x1xi32>, tensor<1x1x1x1xf32>
  }
}
