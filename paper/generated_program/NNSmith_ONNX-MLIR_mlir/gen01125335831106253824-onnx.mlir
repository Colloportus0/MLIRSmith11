module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  llvm.mlir.global external constant @_entry_point_0_out_sig("[   { \22type\22 : \22i32\22 , \22dims\22 : [1 , 1 , 1 , 1] , \22name\22 : \22v5_0\22 }\0A ,    { \22type\22 : \22i1\22 , \22dims\22 : [1 , 1 , 1 , 1] , \22name\22 : \22v2_0\22 }\0A\0A]\00") {addr_space = 0 : i32}
  ...
  ^bb20:  // pred: ^bb19
    ...
    %144 = llvm.extractvalue %43[1] : !llvm.struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)> 
    ...
    %151 = llvm.extractvalue %117[1] : !llvm.struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)> 
    %152 = llvm.add %121, %126  : i64
    %153 = llvm.add %152, %131  : i64
    %154 = llvm.add %153, %136  : i64
  ...
  ^bb24:  // pred: ^bb13
    ...
    %166 = llvm.getelementptr %165[%160] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    ...
    %184 = llvm.insertvalue %160, %183[3, 0] : !llvm.struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)> 
    %185 = llvm.insertvalue %161, %184[3, 1] : !llvm.struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)> 
    %186 = llvm.insertvalue %162, %185[3, 2] : !llvm.struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)> 
    %187 = llvm.insertvalue %163, %186[3, 3] : !llvm.struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)> 
    %188 = llvm.insertvalue %161, %187[4, 0] : !llvm.struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)> 
    %189 = llvm.insertvalue %162, %188[4, 1] : !llvm.struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)> 
    %190 = llvm.insertvalue %163, %189[4, 2] : !llvm.struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)> 
    %191 = llvm.insertvalue %164, %190[4, 3] : !llvm.struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)> 
  ...
  ^bb32:  // pred: ^bb31
    %212 = llvm.extractvalue %117[1] : !llvm.struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)> 
    ...
    %218 = llvm.extractvalue %11[1] : !llvm.struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)> 
    ...
    %224 = llvm.add %217, %223  : i32
    %225 = llvm.extractvalue %191[1] : !llvm.struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)> 
    %226 = llvm.add %195, %200  : i64
    %227 = llvm.add %226, %205  : i64
    %228 = llvm.add %227, %210  : i64
    %229 = llvm.getelementptr %225[%228] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    llvm.store %224, %229 : !llvm.ptr<i32>
    %230 = llvm.add %210, %209  : i64
  ...
  ^bb44:  // pred: ^bb43
    %286 = llvm.extractvalue %191[1] : !llvm.struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)> 
    ...
    %292 = llvm.extractvalue %191[1] : !llvm.struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)> 
    ...
    %298 = llvm.icmp "sgt" %291, %297 : i32
    %299 = llvm.select %298, %291, %297 : i1, i32
    %300 = llvm.extractvalue %265[1] : !llvm.struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)> 
    %301 = llvm.add %269, %274  : i64
    ...
    %305 = llvm.add %284, %283  : i64
    llvm.br ^bb43(%305 : i64)
  ^bb45:  // pred: ^bb43
    %306 = llvm.add %279, %278  : i64
    llvm.br ^bb41(%306 : i64)
  ^bb46:  // pred: ^bb41
    %307 = llvm.add %274, %273  : i64
  ...
  ^bb48:  // pred: ^bb37
    ...
    %315 = llvm.getelementptr %314[%309] : (!llvm.ptr<i1>, i64) -> !llvm.ptr<i1>
    ...
    %328 = llvm.mlir.undef : !llvm.struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)>
    %329 = llvm.insertvalue %320, %328[0] : !llvm.struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)> 
    %330 = llvm.insertvalue %327, %329[1] : !llvm.struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)> 
    %331 = llvm.mlir.constant(0 : index) : i64
    %332 = llvm.insertvalue %331, %330[2] : !llvm.struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)> 
    %333 = llvm.insertvalue %309, %332[3, 0] : !llvm.struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)> 
    %334 = llvm.insertvalue %310, %333[3, 1] : !llvm.struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)> 
    %335 = llvm.insertvalue %311, %334[3, 2] : !llvm.struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)> 
    %336 = llvm.insertvalue %312, %335[3, 3] : !llvm.struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)> 
    %337 = llvm.insertvalue %310, %336[4, 0] : !llvm.struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)> 
    %338 = llvm.insertvalue %311, %337[4, 1] : !llvm.struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)> 
    %339 = llvm.insertvalue %312, %338[4, 2] : !llvm.struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)> 
    %340 = llvm.insertvalue %313, %339[4, 3] : !llvm.struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)> 
  ...
  ^bb56:  // pred: ^bb55
    ...
    %362 = llvm.add %344, %349  : i64
    %363 = llvm.add %362, %354  : i64
    %364 = llvm.add %363, %359  : i64
    ...
    %373 = llvm.icmp "slt" %366, %372 : i32
    %374 = llvm.extractvalue %340[1] : !llvm.struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)> 
    %375 = llvm.add %344, %349  : i64
    %376 = llvm.add %375, %354  : i64
    %377 = llvm.add %376, %359  : i64
    %378 = llvm.getelementptr %374[%377] : (!llvm.ptr<i1>, i64) -> !llvm.ptr<i1>
    llvm.store %373, %378 : !llvm.ptr<i1>
    %379 = llvm.add %359, %358  : i64
    llvm.br ^bb55(%379 : i64)
  ^bb57:  // pred: ^bb55
    %380 = llvm.add %354, %353  : i64
    llvm.br ^bb53(%380 : i64)
  ^bb58:  // pred: ^bb53
    %381 = llvm.add %349, %348  : i64
    llvm.br ^bb51(%381 : i64)
  ^bb59:  // pred: ^bb51
    %382 = llvm.add %344, %343  : i64
    llvm.br ^bb49(%382 : i64)
  ^bb60:  // pred: ^bb49
    %383 = llvm.mlir.undef : !llvm.struct<(struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)>, struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)>)>
    %384 = llvm.insertvalue %265, %383[0] : !llvm.struct<(struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)>, struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)>)> 
    %385 = llvm.insertvalue %340, %384[1] : !llvm.struct<(struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)>, struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)>)> 
    llvm.return %385 : !llvm.struct<(struct<(ptr<i32>, ptr<i32>, i64, array<4 x i64>, array<4 x i64>)>, struct<(ptr<i1>, ptr<i1>, i64, array<4 x i64>, array<4 x i64>)>)>
  }
